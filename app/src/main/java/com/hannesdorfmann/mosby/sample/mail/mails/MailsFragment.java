...
public class MailsFragment extends BaseMailsFragment<MailsView, MailsPresenter>
    ...
    //for Persistent Fragment with FragmentArgs lib
    @Arg
    Label label;
    ...
    @Bind(R.id.createMail)
    FloatingActionButton createMailButton;
    ...
    @Override
    public MailsPresenter createPresenter() {
    ...
    @Override
    public void changeLabel(Mail mail, String labelName) {
