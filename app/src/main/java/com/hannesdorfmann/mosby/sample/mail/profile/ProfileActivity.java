...
public class ProfileActivity
    ...
    @Bind(R.id.fadingToolbarHelper)
    View fadingToolbarHelper;
    ...
    @Override
    public void setData(List<ProfileScreen> data) {
    ...
    @Override
    public List<ProfileScreen> getData() {
